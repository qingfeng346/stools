...
public class MusicKugou : MusicBase {
    ...
    protected override async Task ParseInfo(string id) {
        ...
        musicInfo = JsonConvert.DeserializeObject<MusicInfo>(await HttpUtil.Get($"http://www.kugou.com/yy/index.php?r=play/getdata&hash={id}&album_id={musicInfo.data.album_id}", (message) => {
            message.Headers.Add("Cookie", "kg_mid=42e7c301308736085f5b226d29ef20c51111");
        }));
